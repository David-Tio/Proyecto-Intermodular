...
- `docs/cloud/diagrama_arquitectura.png` → Diagrama de arquitectura AWS
- `docs/cloud/presentacion_cloud.pptx` → Presentación del módulo
---
 
## Autor
 
**David Tío** — SMR 1 · Caja Mágica 
